...
class BaseOptions():
    ...
    def _initialize(self, parser):
        ...
        parser.add_argument('--dataset_name', type=str, help='indicate the dataset name, see HF Hub to know what is available. You can also pass the name of a folder or file in the data/datasets folder.')
